           ...
           <div className="lg:col-span-6 relative">
              ...
              >
                 ...
                 <div className="absolute top-10 right-10 flex flex-col items-end opacity-20">
                    ...
                    <span className="text-[8px] font-bold tracking-[0.6em] uppercase">Private Practice</span>
                 </div>
              </motion.div>
           </div>
        </div>
            ...
            <div className="lg:col-span-7 space-y-16">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-12 border-t border-cream/5">
                  <div className="space-y-4">
                     ...
                     <p className="text-[11px] tracking-widest leading-relaxed text-cream/20">Our treatments are synchronized with your natural aesthetics, ensuring structural integrity and cellular-level compatibility.</p>
                  </div>
                  <div className="space-y-4">
                     <h3 className="text-[10px] font-bold tracking-[0.4em] uppercase text-gold">02. Digital Artisanship</h3>
                     <p className="text-[11px] tracking-widest leading-relaxed text-cream/20">We leverage ultra-high-resolution imaging and AI-driven precision to design smile architectures that are uniquely yours.</p>
                  </div>
                  <div className="space-y-4">
                     <h3 className="text-[10px] font-bold tracking-[0.4em] uppercase text-gold">03. Concierge Sovereignty</h3>
                     <p className="text-[11px] tracking-widest leading-relaxed text-cream/20">Your time is your most finite resource. Our zero-wait protocol and private consultation suites respect your autonomy.</p>
                  </div>
               </div>
            </div>
         </div>
                    ...
                    >
                       <div className="aspect-[4/5] bg-onyx overflow-hidden relative">
                          ...
                          <div className="absolute inset-x-8 bottom-8">
                             <span className="text-[9px] font-bold tracking-[0.5em] uppercase text-gold/80 bg-onyx/90 px-4 py-2 backdrop-blur-sm">{clinician.role}</span>
                          </div>
                       </div>

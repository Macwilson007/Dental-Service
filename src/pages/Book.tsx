            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-12">
               <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                  <div className="space-y-3">
                     <label className="text-[9px] font-bold tracking-[0.4em] uppercase text-gold">CLIENT IDENTIFICATION</label>
                     <input 
                        {...register('fullName')}
                     ...
                     />
                     {errors.fullName && <p className="text-[9px] text-red-500 font-bold uppercase tracking-widest pt-2">{errors.fullName.message}</p>}
                  </div>
                  <div className="space-y-3">
                     <label className="text-[9px] font-bold tracking-[0.4em] uppercase text-gold">PRIMARY CHANNEL (EMAIL)</label>
                     <input 
                        {...register('email')}
                        type="email"
                        ...
                        className="w-full bg-transparent border-b border-onyx/10 p-4 focus:outline-none focus:border-gold transition-all font-serif text-xl"
                     />
                     {errors.email && <p className="text-[9px] text-red-500 font-bold uppercase tracking-widest pt-2">{errors.email.message}</p>}
                  </div>
               </div>

               <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-8">
                  <div className="space-y-3">
                     <label className="text-[9px] font-bold tracking-[0.4em] uppercase text-gold">SECURE CONTACT (MOBILE)</label>
                     <input 
                        {...register('phone')}
                        placeholder="+44 7000 000000"
                        className="w-full bg-transparent border-b border-onyx/10 p-4 focus:outline-none focus:border-gold transition-all font-serif text-xl"
                     />
                     {errors.phone && <p className="text-[9px] text-red-500 font-bold uppercase tracking-widest pt-2">{errors.phone.message}</p>}
                  </div>
                  <div className="space-y-3">
                     <label className="text-[9px] font-bold tracking-[0.4em] uppercase text-gold">REQUIRED PROTOCOL</label>
                     <select 
                     ...
                     {errors.serviceType && <p className="text-[9px] text-red-500 font-bold uppercase tracking-widest pt-2 text-right">{errors.serviceType.message}</p>}
                  </div>
               </div>

               <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-8">
                  <div className="space-y-3">
                     <label className="text-[9px] font-bold tracking-[0.4em] uppercase text-gold">PREFERRED DATE</label>
                     <input 
                        {...register('preferredDate')}
                        type="date"
                        className="w-full bg-transparent border-b border-onyx/10 p-4 focus:outline-none focus:border-gold transition-all font-serif text-xl"
                     />
                     {errors.preferredDate && <p className="text-[9px] text-red-500 font-bold uppercase tracking-widest pt-2">{errors.preferredDate.message}</p>}
                  </div>
                  <div className="space-y-3">
                     <label className="text-[9px] font-bold tracking-[0.4em] uppercase text-gold">TIME WINDOW</label>
                     <select 
                     ...
                     {errors.preferredTime && <p className="text-[9px] text-red-500 font-bold uppercase tracking-widest pt-2 text-right">{errors.preferredTime.message}</p>}
                  </div>
               </div>

               <div className="space-y-3 pt-8">
                  <label className="text-[9px] font-bold tracking-[0.4em] uppercase text-gold">CLINICAL NOTES & REQUESTS</label>
                  <textarea 
                     {...register('notes')}
                     rows={4}
               ...
               <div className="flex items-center gap-4 justify-center pt-8 opacity-20 group">
                  ...
                  <p className="text-[9px] font-bold tracking-[0.1em] uppercase group-hover:opacity-100 transition-opacity">HIPAA SECURE & END-TO-END ENCRYPTED</p>
               </div>
            </form>
          </motion.div>
        </div>

      ...
      >
        ...
        <form onSubmit={handleLogin} className="space-y-12">
            <div className="space-y-4">
               <label className="text-[10px] font-bold tracking-[0.4em] uppercase text-gold/40">IDENTIFICATION (EMAIL)</label>
            ...
            <div className="space-y-4">
               <label className="text-[10px] font-bold tracking-[0.4em] uppercase text-gold/40">SECURE PASSPHRASE</label>
               <div className="relative group">
           ...
           <div className="flex flex-col items-center gap-10 pt-16">
              <div className="text-[10px] font-bold tracking-widest text-gold/30 hover:text-gold transition-colors cursor-help group relative">
                 ...
                 <div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-onyx border border-gold/20 p-3 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">
                    <span className="text-[10px] text-gold uppercase tracking-tighter">Use this for administrative access</span>
                 </div>
              </div>
              <Link to="/" className="text-[10px] font-bold tracking-[0.3em] uppercase opacity-30 hover:opacity-100 transition-opacity text-cream flex items-center gap-4 group">
                 <ArrowRight size={14} className="rotate-180 group-hover:-translate-x-2 transition-transform" />
                 RETURN TO HOME
              </Link>
              <div className="flex items-center gap-4 opacity-10">
                 <ShieldCheck size={20} className="text-gold" />
                 <p className="text-[10px] font-bold tracking-[0.2em] uppercase text-cream">HIPAA PROTECTED ACCESS</p>
              </div>
           </div>
        </form>
      </motion.div>

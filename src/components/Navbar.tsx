      ...
      <div className="max-w-screen-2xl mx-auto flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-5 group">
           ...
           <div className="flex flex-col">
              <span className="text-[11px] font-bold tracking-[0.5em] uppercase text-onyx/80">DENTAL SERVICE</span>
              <span className="text-[8px] font-bold tracking-[0.2em] uppercase text-gold/60 mt-0.5">EST. 2026</span>
           </div>
        </Link>

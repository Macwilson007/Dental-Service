  ...
  return (
    <footer className="py-32 bg-cream border-t border-onyx/5 relative z-10">
      ...
      <div className="section-container mt-32 border-t border-onyx/5 pt-12 flex flex-col md:flex-row justify-between opacity-30">
        <p className="text-[10px] font-bold tracking-[0.4em] uppercase">© 2026 DENTAL SERVICE PRIVATE PRACTICE. ALL RIGHTS RESERVED.</p>
        <div className="flex gap-8 mt-4 md:mt-0">
          <span className="text-[10px] font-bold tracking-[0.4em] uppercase cursor-pointer">PRIVACY</span>
          <span className="text-[10px] font-bold tracking-[0.4em] uppercase cursor-pointer">TERMS</span>
        </div>
      </div>
    </footer>
  )
